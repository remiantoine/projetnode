...
module.exports = class UserService extends Service {
    ...
    async addFavoriteMovie(userId, filmId) {
        ...
        const userFavorites = await Favoris.query().where({ userId });

        // Vérifie si le film est déjà dans les favoris de l'utilisateur
        const isFavorite = userFavorites.some((fav) => fav.filmId === filmId);
