...
module.exports = class MailService extends Service {
    ...
    /**
     * Fonction statique pour créer une instance de MailService.
     * @param {Object} options - Options de configuration pour le service.
     * @returns {MailService} Une instance de MailService.
     */
    static create(options) {
        return new MailService(null, options);
    }
};
